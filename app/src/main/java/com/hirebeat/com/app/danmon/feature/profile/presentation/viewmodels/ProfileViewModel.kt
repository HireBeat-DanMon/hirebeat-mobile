...
//            sessionManager.userRoleName.collect { role ->
//                val isMusician = role == "MUSICIAN"
...
//        viewModelScope.launch {
//            // 1. Esperamos a obtener el rol real antes de validar nada
//            val role = sessionManager.userRoleName.firstOrNull()
//            val isRecruiter = role != "MUSICIAN"
//
//            // 2. Validamos con datos reales
//            if ((userId == null || userId == "my_id") && isRecruiter) {
//                _uiState.update { it.copy(
//                    error = "Los reclutadores no tienen perfil público",
//                    isLoading = false
//                ) }
//                return@launch
//            }
...
//                _uiState.update { it.copy(userProfile = profile, isLoading = false) }
//
//                println("DEBUG_API: Perfil ${profile.fullName} cargado con ${profile.links.size} links")
//            } catch (e: Exception) {
//                _uiState.update { it.copy(isLoading = false, error = e.localizedMessage) }
//            }
//        }
